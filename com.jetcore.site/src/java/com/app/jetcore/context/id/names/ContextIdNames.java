...
public interface ContextIdNames {
    ...
    public static final String STUDENT_ACEDAMIC_DETAIL = "studentAcedamicDetail";
    ...
    public static final String STUDENT_ACEDAMIC_DETAIL_SERVICE = "studentAcedamicDetailService";
}
